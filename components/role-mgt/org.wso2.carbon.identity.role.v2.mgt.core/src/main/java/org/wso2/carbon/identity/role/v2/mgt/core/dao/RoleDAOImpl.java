...
import static org.wso2.carbon.identity.role.v2.mgt.core.dao.SQLQueries.GET_APP_NAME_BY_APP_ID;
...
import static org.wso2.carbon.identity.role.v2.mgt.core.dao.SQLQueries.GET_ROLE_AUDIENCE_BY_ROLE_NAME_SQL;
...
//                    }
    ...
    public Role getRole(String roleID, String tenantDomain) throws IdentityRoleManagementException {
        ...
        if (roleAudience != null) {
            ...
            if (RoleConstants.ORGANIZATION.equalsIgnoreCase(roleAudience.getAudience())) {
...
//    }
    ...
    private String getAudienceName(String audience, String audienceId, String tenantDomain)
        ...
        } else if (RoleConstants.ORGANIZATION.equals(audience)) {
    ...
    private void validateAttributesForSorting(String sortBy, String sortOrder)
        ...
        if (StringUtils.isNotBlank(sortBy) || StringUtils.isNotBlank(sortOrder)) {
            throw new IdentityRoleManagementClientException(RoleConstants.Error.SORTING_NOT_IMPLEMENTED.getCode(),
