...
public class SQLQueries {
    ...
    public static final String ADD_ROLE_WITH_AUDIENCE_SQL = "INSERT INTO UM_HYBRID_ROLE (UM_ROLE_NAME, AUDIENCE_REF_ID, " +
            "UM_TENANT_ID) VALUES (:UM_ROLE_NAME;, :AUDIENCE_ID;, :UM_TENANT_ID;)";
    ...
    public static final String GET_ROLE_SCOPE_SQL = "SELECT NAME, DISPLAY_NAME FROM " +
            "ROLE_SCOPE INNER JOIN SCOPE ON ROLE_SCOPE.SCOPE_NAME = SCOPE.NAME  " +
            "WHERE ROLE_ID =:ROLE_ID; AND ROLE_SCOPE.TENANT_ID =:TENANT_ID;";
    ...
    public static final String GET_ASSOCIATED_APPS_BY_ROLE_ID_SQL = "SELECT APP_ID, APP_NAME FROM " +
            "APP_ROLE_ASSOCIATION INNER JOIN SP_APP ON APP_ROLE_ASSOCIATION.APP_ID = SP_APP.UUID (ROLE_ID, APP_ID) " +
    ...
    public static final String GET_ROLES_BY_TENANT_DB2 = "SELECT UM_ROLE_NAME, AUDIENCE, " +
            ...
            "UM_HYBRID_ROLE.* FROM UM_HYBRID_ROLE INNER JOIN UM_HYBRID_ROLE_AUDIENCE ON UM_HYBRID_ROLE.AUDIENCE_REF_ID = " +
            "UM_HYBRID_ROLE_AUDIENCE.ID WHERE UM_TENANT_ID=:UM_TENANT_ID;)WHERE rn BETWEEN :ONE_BASED_START_INDEX; " +
            "AND :END_INDEX;";
    ...
    public static final String GET_ROLES_BY_TENANT_AND_ROLE_NAME_DB2 = "SELECT UM_ROLE_NAME, AUDIENCE, " +
            "UM_HYBRID_ROLE_AUDIENCE.AUDIENCE_ID FROM (SELECT ROW_NUMBER() OVER(ORDER BY UM_ID DESC) AS rn, " +
            "UM_HYBRID_ROLE.* FROM UM_HYBRID_ROLE INNER JOIN UM_HYBRID_ROLE_AUDIENCE ON UM_HYBRID_ROLE.AUDIENCE_REF_ID = " +
            "UM_HYBRID_ROLE_AUDIENCE.ID WHERE UM_TENANT_ID=:UM_TENANT_ID; AND UM_ROLE_NAME LIKE :UM_ROLE_NAME;) " +
            "WHERE rn BETWEEN :ONE_BASED_START_INDEX; AND :END_INDEX;";
